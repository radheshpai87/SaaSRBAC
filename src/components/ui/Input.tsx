    ...
    return (
      <div className="w-full space-y-1.5">
        ...
        <input
          ...
          ref={ref}
          className={cn(
            "flex h-9 w-full rounded-lg border border-zinc-800 bg-zinc-900/90 px-3 py-1 text-sm text-zinc-100 shadow-xs transition-colors placeholder:text-zinc-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-400 focus-visible:border-zinc-500 disabled:cursor-not-allowed disabled:bg-zinc-900/50 disabled:text-zinc-600",
